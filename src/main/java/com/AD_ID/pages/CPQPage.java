...
//	@Step("Configuring the Demand")
	public CPQPage DemandConfiguration() {
	...
	public CPQPage addToTransaction() {
		eleutil.sleep(3);
	...
	public CPQPage saveAndSubmitforApproval() {
		...
		test.info("Submitted for Approval");
		eleutil.sleep(3);
		return this;
	}

	public CPQPage reqSignature() {
		eleutil.sleep(5);
	...
	public CPQPage submitPricingApproval() {
		eleutil.sleep(5);
		eleutil.waitForElementAndClick(submitPricingAgreement, 20, 2);
		return this;
		
	}
	public CPQPage reconfigure() {
		eleutil.sleep(15);
	...
	public String SubmitPricingApproval() {
		eleutil.sleep(5);
